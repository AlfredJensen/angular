...
export class TransferService {
  ...
  getTransferByFilters(search, referance, fromWareHouse, toWareHouse, statut): Observable<any> {
    return this.apiService.post(`/Transfer/Filter?search=${search}&referance=${referance}&fromWareHouse=${fromWareHouse}&toWareHouse=${toWareHouse}&statut=${statut}`);
  }
