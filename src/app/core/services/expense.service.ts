...
export class ExpenseService {
  ...
  GetFilterExpense(search,date, reference, warehouse, expenseCetory): Observable<any> {
    return this.apiService.get(`/Expense/Filter/?search=${search}&date=${date}&reference=${reference}&warehouse=${warehouse}&expenseCetory=${expenseCetory}`);
  }
