...
export class TranferListComponent implements OnInit {
  ...
  getFilteredData(e) {
      ...
      this.searchdata.referance = this.referance ? this.referance : '';
      ...
      this.transferService.getTransferByFilters(this.searchdata.searchString, this.searchdata.referance, this.searchdata.fromWareHouse, this.searchdata.toWareHouse, this.searchdata.statut).subscribe(
          (response) => {
            if (response) {
